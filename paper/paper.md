...
3. Open ’botA_LC.pdb’ file in a text editor and find x, y and z coordinates of the Cα atom of glutamate (GLU) 262. Write these coordinates down for future reference.
